<%-- 
    Document   : StorageCheckCancel
    Created on : 26 Mar 2025, 05:47:26
    Author     : ANNT1
--%>
            ...
            <main id="main" class="main">
                ...
                <form action="SCheckCancelServlet1" method="post" class="p-3 bg-light rounded shadow-sm">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3 class="mb-0">Storage Check Cancel</h3>
                        <a href="<%= request.getContextPath() %>/DeSCheckInforServlet" class="btn btn-dark">Cancel List</a>
                    </div>
