<%-- 
    Document   : StorageCheckCancel2
    Created on : 26 Mar 2025, 05:48:02
    Author     : ANNT1
--%>
    ...
    <body>
        ...
        <jsp:include page="/common/sidebar.jsp"></jsp:include><!-- End Sidebar-->
            <main id="main" class="main">
                <div class="container">
                    <h2 class="mt-4">Storage Check Cancel</h2>
                    <div class="d-flex mt-3 mb-2">
                        <div>
                            <button type="submit" class="btn btn-danger" name="action" value="cancel" form="storageCheckForm">Cancel</button>
                        </div>

                        <a href="<%= request.getContextPath() %>/SCheckCancelServlet1" class="btn btn-secondary ms-auto">Return</a>
                </div>

                <!-- Form bao quanh bảng -->
                <form action="SCheckCancelServlet2" method="POST" id="storageCheckForm">
