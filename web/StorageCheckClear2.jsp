<%-- 
    Document   : StorageCheckClear2
    Created on : 26 Mar 2025, 03:08:02
    Author     : ANNT1
--%>
    ...
    <body>
        ...
        <jsp:include page="/common/sidebar.jsp"></jsp:include><!-- End Sidebar-->
            <main id="main" class="main">
                <div class="container">
                    <h2 class="mt-4">Storage Check Clear</h2>
                    <div class="d-flex mt-3 mb-2">
                        <div>
                            <button type="submit" class="btn btn-success" name="action" value="clear" form="storageCheckForm">Clear</button>
                            <button type="submit" class="btn btn-primary" name="action" value="recount" form="storageCheckForm">Recount</button>
                        </div>

                        <a href="<%= request.getContextPath() %>/SCheckClearServlet1" class="btn btn-secondary ms-auto">Return</a>
                </div>

                <!-- Form bao quanh bảng -->
                <form action="SCheckClearServlet2" method="POST" id="storageCheckForm">
