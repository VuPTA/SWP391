 ...
 * @author ANNT1
 */
@WebServlet(name = "SCheckCancelServlet1", urlPatterns = {"/SCheckCancelServlet1"})
public class SCheckCancelServlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SCheckCancelServlet1</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SCheckCancelServlet1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (scheckId != null) {
            ...
            if (dao.isNotCancelledOrCleared(ScheckId)) {//check ko phải status cancel hay cleared
                ...
                request.getRequestDispatcher("StorageCheckCancel2.jsp").forward(request, response);
