...
public class UpdateRoleServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        boolean success = dao.updateRole(accountId, newRoleId);

        if (success) {
            response.sendRedirect("listAccounts?success=true");
        } else {
            response.sendRedirect("listAccounts?error=true");
        }
     //s   processRequest(request, response);
    }
